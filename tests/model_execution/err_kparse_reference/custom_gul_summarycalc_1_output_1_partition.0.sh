...
seq 1 1 | parallel --halt now,fail=1 "./custom_gul_summarycalc_1_output_1_partition.0.gulcalc.sh {} $LOG_DIR"  # TODO can we share a single gulcalc script among all the partitions?
