...
find fifo/ \( -name '*P30[^0-9]*' -o -name '*P30' \) -exec rm -R -f {} +
rm -R -f work/*
mkdir -p work/kat/
...
pltcalc -H < fifo/il_S1_pltcalc_P30 > work/kat/il_S1_pltcalc_P30 & pid3=$!
...
pltcalc -H < fifo/gul_S1_pltcalc_P30 > work/kat/gul_S1_pltcalc_P30 & pid8=$!
